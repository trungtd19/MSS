...
namespace MSS_DEMO.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Course_ID,Course_Name,Course_Slug,Specification_ID,Subject_ID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Course_ID,Course_Name,Course_Slug,Specification_ID,Subject_ID")] Course course)
        {
            if (ModelState.IsValid)
            {
